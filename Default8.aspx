        ...
        <div class="row">
            ...
            <section>
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="target.php" runat="server">
<%--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <asp:TextBox ID="password" name="password" CssClass="form-control input-lg" type="password" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <%--<asp:TextBox ID="confirmPassword" runat="server" type="password" class="form-control"></asp:TextBox>--%>
                                <asp:TextBox ID="confirmPassword" name="confirmPassword" CssClass="form-control input-lg" type="password" runat="server"></asp:TextBox>
                            </div>
                        </div>
